...
public class CreateProductDTOValidatorTests
{
    ...
    {
        var dto = new CreatedProductDTO { Name = "", Price = 10, Stock = 10 };
    ...
    {
        var dto = new CreatedProductDTO { Name = new string('a', 31), Price = 10, Stock = 10 };
        var result = validator.Validate(dto);
    ...
    {
        var dto = new CreatedProductDTO { Name = new string('a', 30), Price = 10, Stock = 10 };
        var result = validator.Validate(dto);
    ...
    {
        var dto = new CreatedProductDTO { Name = "Test", Price = 0, Stock = 5 };
        var result = validator.Validate(dto);
    ...
    [Fact]
    public void Should_Pass_When_Price_Is_Exectly_Zero()
    {
        var dto = new CreatedProductDTO { Name = "Test", Price = 0, Stock = 5 };
        var result = validator.Validate(dto);
        result.IsValid.Should().BeTrue();
    ...
    [Fact]
    public void Should_Fail_When_Stock_Is_Zero_Or_Negative()
    {
        var dto = new CreatedProductDTO { Name = "Test", Price = 10, Stock = 0 };
        var result = validator.Validate(dto);
        result.IsValid.Should().BeFalse();
